...
user=$(curl ${CURL_ARGS} -v --tlsv1.2 "https://api.github.com/repos/kubernetes-incubator/kubespray/issues/${issue}/comments" \
...
curl ${CURL_ARGS} -v --tlsv1.2 "https://api.github.com/orgs/kubernetes-incubator/members/${user}"
